...
export const AchievementsContent: ReadonlyArray<AchievementsContentProps> = [
  {
    title: "International Conference on Advancement in Data Science, E-learning, and Information System (ICADEIS 2025)",
  ...
  {
    title: "Bangkit Academy led by Google, Tokopedia, Gojek, & Traveloka Cloud Computing Path 2024",
  ...
  },
  {
    ...
    producer_contacts: ["https://www.tanamduit.com/", "https://www.instagram.com/tanamduit.id/"],
    credentials_id: "Credentials",
    credentials_url: "https://www.instagram.com/tanamduit.id/p/ChmgfzOvmN_/?img_index=3",
