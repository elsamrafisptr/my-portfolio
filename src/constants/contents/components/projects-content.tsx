...
export const ProjectsContent: ReadonlyArray<ProjectsContentProps> = [
  {
    ...
    assetsImage: ['/stuntfree-app.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/islamic-education.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/healthcare-registration-system.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/cv-upb-berkah-tani.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/cooleath-official-website.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/mobile-recipe-app.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/e-grocery-app.webp', '/bg.jpg'],
    description:
  ...
  },
  {
    ...
    assetsImage: ['/roufish-app.webp', '/bg.jpg'],
    description:
